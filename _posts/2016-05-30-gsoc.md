...
$$
    \begin{center}\hspace{-5em} {$s_{i}...s_{n}$} is a letter sequence in the source script, and \\ {$t_{i}...t_{n}$} is the corresponding letter sequence in the target script.\end{center}
$$
