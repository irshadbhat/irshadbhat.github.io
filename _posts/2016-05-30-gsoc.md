...
Note that *l<sub>i-n</sub>* and <span lang="latex">l_{i+n}</span> represent the *nth* preceding and succeeding letters of a given letter *<span lang="latex">l_{i}</span>*.
