...
<table class="table-fill">
<tr>
<th><b>Nram</b></th> <th><b>Features</b></th>
</tr>
<tr>
<td>Unigrams</td>  <td>[<span lang="latex">l_{i-4}</span>], [<span lang="latex">l_{i-3}</span>], [<span lang="latex">l_{i-2}</span>], [<span lang="latex">l_{i-1}</span>], [<span lang="latex">l_{i}</span>], [<span lang="latex">l_{i+1}</span>], [<span lang="latex">l_{i+2}</span>], [<span lang="latex">l_{i+3}</span>], [<span lang="latex">l_{i+4}</span>]</td>
</tr>
<tr>
<td>Bigrams</td>  <td>[<span lang="latex">l_{i-4}</span> <span lang="latex">l_{i-3}</span>], [<span lang="latex">l_{i-3}</span> <span lang="latex">l_{i-2}</span>], [<span lang="latex">l_{i-2}</span> <span lang="latex">l_{i-1}</span>], [<span lang="latex">l_{i-1}</span> <span lang="latex">l_{i}</span>], [<span lang="latex">l_{i}</span> <span lang="latex">l_{i+1}</span>], [<span lang="latex">l_{i+1}</span> <span lang="latex">l_{i+2}</span>], [<span lang="latex">l_{i+2}</span> <span lang="latex">l_{i+3}</span>], [<span lang="latex">l_{i+3}</span> <span lang="latex">l_{i+4}</span>]</td>
</tr>
<tr>
<td>Trigrams</td>  <td>[<span lang="latex">l_{i-4}</span> <span lang="latex">l_{i-3}</span> <span lang="latex">l_{i-2}</span>], [<span lang="latex">l_{i-3}</span> <span lang="latex">l_{i-2}</span> <span lang="latex">l_{i-1}</span>], [<span lang="latex">l_{i-2}</span> <span lang="latex">l_{i-1}</span> <span lang="latex">l_{i}</span>], [<span lang="latex">l_{i}</span> <span lang="latex">l_{i+1}</span> <span lang="latex">l_{i+2}</span>], [<span lang="latex">l_{i+1}</span> <span lang="latex">l_{i+2}</span> <span lang="latex">l_{i+3}</span>], [<span lang="latex">l_{i+2}</span> <span lang="latex">l_{i+3}</span> <span lang="latex">l_{i+4}</span>]</td>
</tr>
<tr>
<td>Tetragrams</td>  <td>[<span lang="latex">l_{i-4}</span> <span lang="latex">l_{i-3}</span> <span lang="latex">l_{i-2}</span> <span lang="latex">l_{i-1}</span>], [<span lang="latex">l_{i-3}</span> <span lang="latex">l_{i-2}</span> <span lang="latex">l_{i-1}</span> <span lang="latex">l_{i}</span>], [<span lang="latex">l_{i-2}</span> <span lang="latex">l_{i-1}</span> <span lang="latex">l_{i}</span> <span lang="latex">l_{i+1}</span>], [<span lang="latex">l_{i-1}</span> <span lang="latex">l_{i}</span> <span lang="latex">l_{i+1}</span> <span lang="latex">l_{i+2}</span>], [<span lang="latex">l_{i}</span> <span lang="latex">l_{i+1}</span> <span lang="latex">l_{i+2}</span> <span lang="latex">l_{i+3}</span>], [<span lang="latex">l_{i+1}</span> <span lang="latex">l_{i+2}</span> <span lang="latex">l_{i+3}</span> <span lang="latex">l_{i+4}</span>]</td>
</tr>
</table>
</center>
</p>

Note that *<span lang="latex">l_{i-n}</span>* represents the previous nth letter and *<span lang="latex">l_{i+n}</span>* represents the following nth letter of a given letter *<span lang="latex">l_{i}</span>*.
