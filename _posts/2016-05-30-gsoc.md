...
In order to train the transliteration system, we need to character align the transliteration pairs obtained above. We again use GIZA++ for this task. The resulting character alignments obtained using GIZA++ will look like:
